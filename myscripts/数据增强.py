...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default=r'E:\code_for_school\ISAT_with_segment_anything-master\datasets\train\images')
    parser.add_argument('--source_xml_path', type=str, default=r'E:\code_for_school\ISAT_with_segment_anything-master\output\train')
    parser.add_argument('--save_img_path', type=str, default=r'E:\code_for_school\ISAT_with_segment_anything-master\output\images2')
    parser.add_argument('--save_xml_path', type=str, default=r'E:\code_for_school\ISAT_with_segment_anything-master\output\labels2')
    ...
    for parent, _, files in os.walk(source_img_path):
        ...
        for file in files:
            ...
            while cnt < need_aug_num:  # 继续增强
                ...
                height, width, channel = auged_img.shape  # 得到图0片的属性
